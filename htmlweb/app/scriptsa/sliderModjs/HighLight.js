define(['sMods/Helper'], function(Helper) {
	return function() {
		var tabList;
		var bodyBindClick;
			    ...
			    switch (id) {
			        case "tabTap":
			            ...
			            if (showHide === -1) {
			                ...
			                var leftMinusPadding = offsetPos.left + this.helper.getCSSint($('#labelsFirstCol').css('padding-left'));
			                ...
			                //document.getElementById('labelsFirstCol').className = this.helper.removeClass('labelsFirstCol', 'selectBackground');
			        ...
			        case "tabSlide":
			            ...
			            if (showHide === -1) {
	                        ...
	                        if (modules.uiType == 'ui1') {
			            	    this.helper.updateClassNamesAdd('slider', ' bc');
			            	}
			            	else if (modules.uiType == 'ui2') {
			            	    this.helper.updateClassNamesAdd('scorer', ' bc');
			            	}
			            	else {
			                ...
			                var widthMinusPadding = tapTabWidth - this.helper.getCSSint($('#labelsSecondCol').css('padding-left'));
			                document.getElementById('sliderNav').style.background = '0';
			                ...
			                document.getElementById('sliderNavWrapper').className = this.helper.addClass('sliderNavWrapper', 'selectedCBC');
			                ...
			                document.getElementById('sliderNavWrapper').className = this.helper.removeClass('sliderNavWrapper', 'selectedCBC');
			                if (modules.uiType == 'ui2') {
			                    this.helper.updateClassNamesRemove('scorer', 'bc');
			                }
			                else {
			                    this.helper.updateClassNamesRemove('slider', 'bc');
			                }
			                this.updateOverlay('highLightOverlay1', 0, 0, 0, 0, '', false);
			                this.updateOverlay('highLightOverlay2', 0, 0, 0, 0, '', false);
			                this.currentHighLighted1 = 'null';
			        ...
			        case "tabDecide":
			            ...
			            if (showHide === -1) {
			                ...
			                document.getElementById('results').className = this.helper.addClass('results', 'selectedCBC');
			                ...
			                this.helper.removeClass('results', 'selecetedCBC');
			                document.getElementById('results').className = this.helper.removeClass('results', 'selectedCBC');
			        ...
			        case "tabShare":
			            ...
			            if (showHide === -1) {
			            	this.removeHighLightOverlay();
			            	this.bodyRemoveHighLight();
			            	document.getElementById('tabShare').className = this.helper.addClass( 'tabShare', 'selectBackground');
			            	document.getElementById('results').className = this.helper.addClass('results', 'resultsDisplayNone');
			            ...
			            //	this.updateOverlay('highLightOverlay1', 0, $(window).width(), 'tabDecide', false);
			            	...
			            	document.getElementById('results').className = this.helper.removeClass('results', 'resultsDisplayNone');
