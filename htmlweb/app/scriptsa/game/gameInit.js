define(['game/oimo', 'game/v3d'], function(OIMO,V3D) {
    ...
    var canvas = document.getElementById('container');
        ...
        return {
                        ...
                        if(!body.getSleep()){ // if body didn't sleep
                            ...
                            if(body.name == 'shp1'){
                               ...
                               var tmpPosZ = (containerMesh.position.z - containerMeshPrev.z); 
                                ...
                                if(v3d.startRot.rot){
                                    v3d.log('rot started cam', 'oimoLoop');
            ...
            populate: function(n) {
                ...
                var spheres = [{ "size":[7.5, 7.5, 7.5], "pos":[0,1,0], "move":"true", "name":"shp1", "color":'#66ff33', "image":'shp1.jpg'},
                ...
                //proBox = { type:'box', size:[300, 240, 0.5], pos:[0,0,-100], move:true, world:world, name:'proBox' };
