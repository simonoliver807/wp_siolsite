define(['game/three'], function(THREE) {
'use strict';
var THREE;
var V3D = {};
...
V3D.View = function(h,v,d){
    ...
    this.startRot = { issleeping: 1, rot: 0, camAngle: 0.05, axis: new THREE.Vector3() };
...
V3D.View.prototype = {
    ...
    applyRot: function (issleeping) {
            ...
            //this.log('2 rot: ', this.tmpVCPprev);
          ...
          // //  this.log('amount of rot cam: ', tmpVCP)
         ...
         //   this.log('3 rot: ', this.tmppbprev);

           //  var tmpVCP = new THREE.Vector3();
           //  tmpVCP.copy(this.tmppbprev);
           //  tmpVCP.applyAxisAngle( this.axis, this.camAngle );

           //  this.log('tmpVCP.applyAxisAngle', tmpVCP);
           ...
           // this.log('tmppbprev ', this.tmppbprev);
...
//           this.log('is sleeping', this.startRot.issleeping);
 //          this.log('rotation', this.startRot.rot);
